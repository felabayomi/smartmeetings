...
export function HowToUse() {
  return <InformationPage title="How to Use MeetMind" intro="A practical guide to managing your calendar, sharing availability, booking meetings, and finding a group consensus.">
    ...
    <section><h2>6. Install on a phone</h2><p>If MeetMind was previously installed from another address, remove that older copy first. In your phone’s regular browser, open either <a className="text-primary underline" href="https://www.meetminder.app">www.meetminder.app</a> or <a className="text-primary underline" href="https://www.meetmind.us">www.meetmind.us</a>. Sign in through the browser and confirm that your calendar loads correctly. Then use the browser menu to choose Add to Home Screen or Install App. Continue using the same domain so your installed app and browser session remain connected.</p></section>
