...
const { expandRecurrence, normalizeRecurrence, RecurrenceError } = require('./recurrence.cjs');

const columns = {title:'title',description:'description',timezone:'timezone',location:'location',organizer:'organizer',meetingUrl:'meeting_url',notes:'notes',reminderMinutes:'reminder_minutes',reminderMinutes2:'reminder_minutes_2',reminderMinutes3:'reminder_minutes_3',reminderMinutes4:'reminder_minutes_4',color:'color',sourceScanId:'scan_source_id'};
let ready;
function ensureRecurrenceTables(pool) {
...
async function createSeries(client, owner, template, rawRule) {
...
async function materializeSeries(pool, owner = null) {
...
async function excludeOccurrence(client, row) {
...
exports.ensureRecurrenceTables = ensureRecurrenceTables;
exports.createSeries = createSeries;
exports.materializeSeries = materializeSeries;
exports.excludeOccurrence = excludeOccurrence;
