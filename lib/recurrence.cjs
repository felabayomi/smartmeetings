...
const DAY = 86400000;
function normalizeRecurrence(input, startTime) {
...
function expandRecurrence(template, rule, horizon) {
...
exports.RecurrenceError = RecurrenceError;
exports.normalizeRecurrence = normalizeRecurrence;
